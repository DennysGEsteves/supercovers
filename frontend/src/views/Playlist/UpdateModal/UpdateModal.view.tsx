...
import logic from './UpdateModal.logic';
import { UpdatePlaylistModalProps } from './UpdateModal.props';

const UpdatePlaylistModal: NextPage<UpdatePlaylistModalProps> = (props) => {
  ...
  return (
    <Modal isOpen={data.isModalOpen} onClose={methods.closeModal} isCentered size='3xl'>
      ...
      <ModalContent bg='gray.800' as='form' onSubmit={methods.handleSubmit(methods.submit)}>
        <ModalHeader color='white'>Editar playlist</ModalHeader>
